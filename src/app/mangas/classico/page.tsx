...
import mangaClassicoVolumes from '../../data/mangaClassicoVolumes';

export default function MangaClassico() {
  const [currentSaga, setCurrentSaga] = useState(mangaClassicoVolumes[0]); 
